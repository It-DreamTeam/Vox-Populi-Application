...
<header>
    ...
    <div class="container">
    	...
    	<div id="card" class="weather">
    		...
    		<div class="details">
    			<div class="temp" id="temperature_ville">Temp</div>
					<div class="temp" id="name_ville">Ville</div>
    			<div class="right">
    				<div id="date">
							<script>
							var ladate=new Date()
...
<div class="wrapper">
	<div id="header_wrapper">
		<a class="btn btn-block google btn-danger" href="<?= $this->Url->build(['action' => 'index']); ?>"><i
						class="fa fa-reply"></i> Changer de ville</a>
	</div>
	<div id="proposition">
